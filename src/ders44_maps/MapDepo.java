...
public class MapDepo {
    ...
    public static Map<Integer, String> ogrenciYeniSubeAta(Map<Integer, String> ogrenciMap, int ogrenciKey, String yenisube) {
        if (ogrenciMap.containsKey(ogrenciKey)) {
            ...
            String[] istenenKeyinValueArr = istenenKeyinValuesu.split("-");
            istenenKeyinValueArr[3] = yenisube;
            String istenenKeyinYeniValesu = istenenKeyinValueArr[0] + "-" +
                    istenenKeyinValueArr[1] + "-" +
                    istenenKeyinValueArr[2] + "-" +
                    istenenKeyinValueArr[3] + "-" +
                    istenenKeyinValueArr[4];
